...
def main():
    ...
    model_rpath = os.path.join(script_dir, "runs", "detect", "apd_bgn", "cctv_model", "weights", "best.pt")
    ...
    if os.path.exists(model_rpath):
        ...
        model_path = "/Users/hy4-mac-002/hasdev/myEaiApp/runs/detect/apd_bgn/cctv_model/weights/best.pt"
